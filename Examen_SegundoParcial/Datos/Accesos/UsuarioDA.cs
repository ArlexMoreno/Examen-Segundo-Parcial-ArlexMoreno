...
namespace Datos.Accesos
{
    ...
    {
        readonly string cadena = "Server=localhost; Port=3306; Database=examen; Uid=root; Pwd=Moreno22;";
        ...
        public bool InsertarUsuario(Usuario usuario)
        {
            ...
            try
            {
                string sql = "INSERT INTO usuario VALUES (@Codigo, @Nombre, @Clave, @EstaActivo);";
        ...
        public bool ModificarUsuario(Usuario usuario)
        {
            ...
            try
            {
                string sql = "UPDATE usuario SET Codigo = @Codigo, Nombre = @Nombre,  Clave = @Clave, EstaActivo = @EstaActivo WHERE Codigo = @Codigo;";
